...
function varargout = interfaz_2(varargin)
% INTERFAZ_2 MATLAB code for interfaz_2.fig
%      INTERFAZ_2, by itself, creates a new INTERFAZ_2 or raises the existing
%      singleton*.
%
%      H = INTERFAZ_2 returns the handle to a new INTERFAZ_2 or the handle to
%      the existing singleton*.
%
%      INTERFAZ_2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in INTERFAZ_2.M with the given input arguments.
%
%      INTERFAZ_2('Property','Value',...) creates a new INTERFAZ_2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before interfaz_2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to interfaz_2_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help interfaz_2

% Last Modified by GUIDE v2.5 28-Aug-2023 22:04:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @interfaz_2_OpeningFcn, ...
                   'gui_OutputFcn',  @interfaz_2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before interfaz_2 is made visible.
function interfaz_2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to interfaz_2 (see VARARGIN)

% Choose default command line output for interfaz_2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes interfaz_2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = interfaz_2_OutputFcn(hObject, eventdata, handles) 
